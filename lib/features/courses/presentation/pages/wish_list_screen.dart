...
class _WishListScreenState extends State<WishListScreen> {
  ...
  List<CourseModel> get filteredCourses {
    if (selectedFilter == 'Lessons') return lessons;
    return lessons.where((c) => c.status == selectedFilter).toList();
  }
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
             ...
             CustomAppBar(title: 'Wish List'),
             SizedBox(height: context.propHeight(24)),
            Wrap(
              spacing: 10,
              children: [
                buildTab('Lessons'),
                buildTab('Recommended courses(4)'),
